package com.ironhack.librarybookapplication.security;

import com.ironhack.librarybookapplication.security.filters.CustomAuthenticationFilter;
import com.ironhack.librarybookapplication.security.filters.CustomAuthorizationFilter;
...
public class SecurityConfig {
    ...
    protected SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests((requests) -> requests
                ...
                .requestMatchers(POST,"/api/generaluser**").hasAnyAuthority("ROLE_USER", "ROLE_ADMIN")
                .requestMatchers(POST,"/api/library_staff**").hasAnyAuthority("ROLE_USER", "ROLE_ADMIN")
